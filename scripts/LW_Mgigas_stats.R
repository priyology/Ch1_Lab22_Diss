...
ggsave(filename = "fig_output/model_Olurida_Length-MHW.Tide.png", width = 5.10, height = 5.77, dpi = 300)
...
ggsave(filename = "fig_output/model_Olurida_Length-SH_Temp.png", width = 5.10, height = 5.77, dpi = 300)
...
ggsave(filename = "fig_output/DARKmodel_Olurida_Length-MHW.Tide.png", width = 5.10, height = 5.77, dpi = 300)
...
ggsave(filename = "fig_output/DARKmodel_Olurida_Length-SH_Temp.png", width = 5.10, height = 5.77, dpi = 300)
